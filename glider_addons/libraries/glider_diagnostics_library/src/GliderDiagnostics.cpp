...
diagnostic_msgs::DiagnosticStatus GliderDiagnostics::setDiagnosisMsg(const uint8_t &level, const std::string &name, const std::string &message, 
...
void GliderDiagnostics::addKeyValue(diagnostic_msgs::DiagnosticArray *diagnostic_msg, const std::string &key_name, const std::string &value, const unsigned int &index)
{
  	// +.+ add key values
...
void GliderDiagnostics::warnLevel(diagnostic_msgs::DiagnosticArray *diagnostic_msg, const std::string &message, const unsigned int &index)
{
  	diagnostic_msg->status[index].level = diagnostic_msgs::DiagnosticStatus::WARN;
		diagnostic_msg->status[index].message = message; 
}

void GliderDiagnostics::errorLevel(diagnostic_msgs::DiagnosticArray *diagnostic_msg, const std::string &message, const unsigned int &index)
{
